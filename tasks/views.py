...
def create_task(request):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'create_task.html', {'form' : TaskForm, 'error' : 'Ingrese datos Válidos'})
...
def task_detail(request, task_id):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'task_detail.html', {'task' : task, 'form' : form, 'error' : 'No se pudo actualizar la tarea'})
